...
): BaseResponse<PaginatorModel<ScenarioInfoModel>> => {
    return axios.get<PaginatorModel<ScenarioInfoModel>>(apiRoutes.scenario.scenario(), {
        ...config,
        params
    })
}
...
export const createScenario = (
    ...
    return axios.post<ScenarioModel>(apiRoutes.scenario.scenario(), null, {
        ...config,
        params: {name}
    })
}
